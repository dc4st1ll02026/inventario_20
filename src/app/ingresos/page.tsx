...
export default function NuevoIngresoPage() {
  ...
  const agregarItem = () => {
    ...
    const itemExistente = items.find(i => i.productId === selectedProducto!.id)
    if (itemExistente) {
      toast({
        variant: 'destructive',
    ...
    const precio = precioUnitario ? parseFloat(precioUnitario) : selectedProducto!.price
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 pt-4 border-t">
                  ...
                  <div className="space-y-4">
                    {/* Componente ProductSearch simple */}
                    <ProductSearch
                      productos={productos}
